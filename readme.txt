...
Create your own custom travel map. Link locations on the map to blog posts and share your travel schedule.
...
= 1.0.1 =
* Fixed an interface bug that in some cases resulted in a "setMap is not a function" javascript error, which broke the location search
